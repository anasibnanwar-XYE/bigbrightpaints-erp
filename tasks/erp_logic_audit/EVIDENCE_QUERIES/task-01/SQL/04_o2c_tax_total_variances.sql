...
--
-- Purpose:
--   Detect tax/total arithmetic mismatches for sales orders and invoices.
-- Notes:
--   These are arithmetic checks only; policy/rounding context required to confirm faults.
