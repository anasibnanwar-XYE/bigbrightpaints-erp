...
--
-- Purpose:
--   Journals that look like O2C system entries (INV-/COGS-) but are not linked back to source documents.
-- Caveat:
--   Manual journals may legitimately appear here; treat as lead unless confirmed.
