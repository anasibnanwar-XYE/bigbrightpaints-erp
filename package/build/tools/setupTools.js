...
export const setupTools = (server) => {
    ...
    server.tool('search', getSearchDescription(), {
    ...
    // 获取 Linux.do 文章工具
    server.tool('fetchLinuxDoArticle', "Fetch full article content from a linux.do post URL", {
    ...
    // 获取 CSDN 文章工具
    server.tool('fetchCsdnArticle', "Fetch full article content from a csdn post URL", {
    ...
    // 获取 GitHub README 工具
    server.tool('fetchGithubReadme', "Fetch README content from a GitHub repository URL", {
    ...
    // 获取掘金文章工具
    server.tool('fetchJuejinArticle', "Fetch full article content from a Juejin(掘金) post URL", {
