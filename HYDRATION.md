...
- Branch: `debug-02-endpoint-matrix` (Task 02 complete, tip `f210004`)
- Dirty: no
...
1. Task 02 complete on `debug-02-endpoint-matrix` at `f210004`.
2. Push branch `debug-02-endpoint-matrix`.
