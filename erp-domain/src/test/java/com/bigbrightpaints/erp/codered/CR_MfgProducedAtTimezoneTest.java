...
class CR_MfgProducedAtTimezoneTest extends AbstractIntegrationTest {
    ...
    void producedAt_usesCompanyTimezone_forLocalInputsAroundMidnight() {
        ...
        ProductionLog first = productionLogRepository.findById(
                productionLogService.createLog(new ProductionLogRequest(
        ...
        ProductionLog second = productionLogRepository.findById(
                productionLogService.createLog(new ProductionLogRequest(
                        product.getBrand().getId(),
                        product.getId(),
                        "Blue",
        ...
        JournalEntry firstJournal = journalEntryRepository
                .findByCompanyAndReferenceNumber(company, first.getProductionCode() + "-RM")
                .orElseThrow();
        JournalEntry secondJournal = journalEntryRepository
