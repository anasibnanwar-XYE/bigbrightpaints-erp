...
public final class AccountingInvariantAssertions {
  ...
  public static void assertDebitsEqualCredits(
      List<BigDecimal> debits, List<BigDecimal> credits, BigDecimal tolerance, String context) {
    ...
    assertTrue(
        ...
        () ->
            context
                + " expected balanced entry but delta="
                + delta
                + " (debit="
                + debitTotal
                + ", credit="
  ...
  public static void assertWithinTolerance(
      BigDecimal expected, BigDecimal actual, BigDecimal tolerance, String context) {
