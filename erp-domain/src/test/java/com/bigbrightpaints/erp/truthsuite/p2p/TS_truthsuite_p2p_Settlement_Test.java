...
class TS_truthsuite_p2p_Settlement_Test {
  ...
  void settlementOverrideFailClosedOnMissingReferenceAndWrongReason() {
    SettlementApprovalDecision validOverride =
    ...
    SettlementApprovalDecision wrongReason =
        new SettlementApprovalDecision(
            "APP-S2",
            "maker-a",
            "checker-b",
  ...
  void settlementOverrideSucceedsWithValidApprovalAndEnforcesSupplierExceptionCode() {
    SettlementApprovalDecision validOverride =
        new SettlementApprovalDecision(
            ...
            Instant.parse("2026-02-20T00:00:00Z"),
            Map.of("ticket", "TKT-ERP-STAGE-095", "approvalSource", "workflow"));
    SettlementApprovalDecision supplierException =
        new SettlementApprovalDecision(
            "APP-S4",
            "maker-c",
            "checker-d",
    ...
    assertThrows(
        ApplicationException.class, () -> policy.requireSupplierExceptionApproval(validOverride));
  }
}
