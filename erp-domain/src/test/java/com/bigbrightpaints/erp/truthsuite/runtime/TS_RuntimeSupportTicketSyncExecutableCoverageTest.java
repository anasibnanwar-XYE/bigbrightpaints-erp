...
class TS_RuntimeSupportTicketSyncExecutableCoverageTest {
  ...
  void submitGitHubIssueAsync_mapsSupportCategoryToSupportLabel() {
    SupportTicketRepository supportTicketRepository =
        org.mockito.Mockito.mock(SupportTicketRepository.class);
    ...
    SupportTicketGitHubSyncService service =
        new SupportTicketGitHubSyncService(
            supportTicketRepository, userAccountRepository, gitHubIssueClient, emailService);
  ...
  void syncGithubStatus_closedIssue_marksResolvedAndSendsNotification() {
    ...
    when(gitHubIssueClient.fetchIssueState(4567L))
        .thenReturn(
