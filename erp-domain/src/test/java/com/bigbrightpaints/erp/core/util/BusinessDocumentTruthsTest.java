...
class BusinessDocumentTruthsTest {
  ...
  void salesOrderLifecycle_staysNotEligibleBeforeInvoiceOrJournalTruthExists() {
    ...
    assertThat(BusinessDocumentTruths.salesOrderLifecycle(order).workflowStatus())
        .isEqualTo("READY_TO_SHIP");
    assertThat(BusinessDocumentTruths.salesOrderLifecycle(order).accountingStatus())
  ...
  void salesOrderLifecycle_defaultsAndPendingStateAreDerivedFromFulfillmentTruth() {
    ...
    assertThat(BusinessDocumentTruths.salesOrderLifecycle(null).workflowStatus())
        .isEqualTo("DRAFT");
    assertThat(BusinessDocumentTruths.salesOrderLifecycle(null).accountingStatus())
        .isEqualTo("NOT_ELIGIBLE");
    assertThat(BusinessDocumentTruths.salesOrderLifecycle(order).accountingStatus())
        .isEqualTo("PENDING");
  }
  ...
  void packagingSlipLifecycle_marksPostedWhenInvoiceOrJournalTruthExists() {
    ...
    assertThat(BusinessDocumentTruths.packagingSlipLifecycle(slip).workflowStatus())
        .isEqualTo("DISPATCHED");
    assertThat(BusinessDocumentTruths.packagingSlipLifecycle(slip).accountingStatus())
        .isEqualTo("POSTED");
  }

  @Test
  void packagingSlipLifecycle_defaultsToPendingWhenNoPostingTruthExists() {
    assertThat(BusinessDocumentTruths.packagingSlipLifecycle(null).workflowStatus())
        .isEqualTo("PENDING");
    assertThat(BusinessDocumentTruths.packagingSlipLifecycle(null).accountingStatus())
        .isEqualTo("PENDING");
  }
  ...
  void invoiceLifecycle_andJournalLifecycle_followWorkflowAndJournalState() {
    ...
    assertThat(BusinessDocumentTruths.invoiceLifecycle("ISSUED", postedJournal).accountingStatus())
        .isEqualTo("POSTED");
    assertThat(BusinessDocumentTruths.invoiceLifecycle("BLOCKED", null).accountingStatus())
        .isEqualTo("BLOCKED");
    assertThat(
            BusinessDocumentTruths.invoiceLifecycle("VOIDED", reversedJournal).accountingStatus())
        .isEqualTo("REVERSED");
    assertThat(BusinessDocumentTruths.journalLifecycle(reversedJournal).accountingStatus())
        .isEqualTo("REVERSED");
  }
  ...
  void invoiceLifecycle_andJournalLifecycle_coverDraftPendingAndFailedBranches() {
    ...
    assertThat(BusinessDocumentTruths.invoiceLifecycle(null, null).accountingStatus())
        .isEqualTo("NOT_ELIGIBLE");
    assertThat(BusinessDocumentTruths.invoiceLifecycle("ISSUED", null).accountingStatus())
        .isEqualTo("PENDING");
    assertThat(
            BusinessDocumentTruths.purchaseLifecycle(new RawMaterialPurchase()).accountingStatus())
        .isEqualTo("PENDING");
    assertThat(BusinessDocumentTruths.journalLifecycle(failedJournal).accountingStatus())
        .isEqualTo("BLOCKED");
  }
  ...
  void goodsReceiptLifecycle_andPurchaseLifecycle_followLinkedPurchaseJournalTruth() {
    ...
    assertThat(BusinessDocumentTruths.purchaseLifecycle(purchase).accountingStatus())
        .isEqualTo("POSTED");
    assertThat(BusinessDocumentTruths.goodsReceiptLifecycle(receipt, purchase).workflowStatus())
        .isEqualTo("INVOICED");
    assertThat(BusinessDocumentTruths.goodsReceiptLifecycle(receipt, purchase).accountingStatus())
        .isEqualTo("POSTED");
    assertThat(BusinessDocumentTruths.goodsReceiptLifecycle(receipt, null).accountingStatus())
        .isEqualTo("PENDING");
  }
  ...
  void purchaseLifecycle_andSettlementLifecycle_coverBlockedAndReversedBranches() {
    ...
    assertThat(BusinessDocumentTruths.purchaseLifecycle(blockedPurchase).accountingStatus())
        .isEqualTo("BLOCKED");
    assertThat(BusinessDocumentTruths.settlementLifecycle(reversedJournal).accountingStatus())
        .isEqualTo("REVERSED");
  }
  ...
  void lifecycleHelpers_coverPostedBlockedAndCancelledJournalStatuses() {
    ...
    assertThat(BusinessDocumentTruths.invoiceLifecycle("ISSUED", paidJournal).accountingStatus())
        .isEqualTo("POSTED");
    assertThat(BusinessDocumentTruths.invoiceLifecycle("ISSUED", settledJournal).accountingStatus())
        .isEqualTo("POSTED");
    assertThat(BusinessDocumentTruths.invoiceLifecycle("ISSUED", closedJournal).accountingStatus())
        .isEqualTo("POSTED");
    assertThat(BusinessDocumentTruths.invoiceLifecycle("ISSUED", blockedJournal).accountingStatus())
        .isEqualTo("BLOCKED");
    assertThat(BusinessDocumentTruths.journalLifecycle(cancelledJournal).accountingStatus())
        .isEqualTo("REVERSED");
  }
  ...
  void invoiceAndGoodsReceiptLifecycle_coverPendingAndNotEligibleBranches() {
    ...
    assertThat(BusinessDocumentTruths.invoiceLifecycle("DRAFT", null).accountingStatus())
        .isEqualTo("NOT_ELIGIBLE");
    assertThat(BusinessDocumentTruths.invoiceLifecycle("ISSUED", null).accountingStatus())
        .isEqualTo("PENDING");
    assertThat(BusinessDocumentTruths.goodsReceiptLifecycle(receipt, null).accountingStatus())
  ...
  void settlementLifecycle_andReference_preserveDocumentMetadata() {
    ...
    LinkedBusinessReferenceDto reference =
    ...
    assertThat(BusinessDocumentTruths.settlementLifecycle(null).accountingStatus())
        .isEqualTo("PENDING");
  }
  ...
  void lifecycleHelpers_coverNullBlankAndDefaultBranches() {
    ...
    assertThat(BusinessDocumentTruths.goodsReceiptLifecycle(null, linkedPurchase).workflowStatus())
        .isEqualTo("RECEIVED");
    assertThat(
            BusinessDocumentTruths.goodsReceiptLifecycle(null, linkedPurchase).accountingStatus())
        .isEqualTo("PENDING");
    assertThat(BusinessDocumentTruths.purchaseLifecycle(null).workflowStatus()).isEqualTo("POSTED");
    assertThat(BusinessDocumentTruths.purchaseLifecycle(null).accountingStatus())
        .isEqualTo("PENDING");
    assertThat(BusinessDocumentTruths.journalLifecycle(null).workflowStatus()).isEqualTo("DRAFT");
    assertThat(BusinessDocumentTruths.journalLifecycle(null).accountingStatus())
        .isEqualTo("PENDING");
    assertThat(BusinessDocumentTruths.invoiceLifecycle("   ", draftJournal).accountingStatus())
        .isEqualTo("NOT_ELIGIBLE");
    assertThat(BusinessDocumentTruths.invoiceLifecycle("cancelled", null).accountingStatus())
        .isEqualTo("REVERSED");
    assertThat(BusinessDocumentTruths.invoiceLifecycle("issued", draftJournal).accountingStatus())
        .isEqualTo("PENDING");
  }
}
