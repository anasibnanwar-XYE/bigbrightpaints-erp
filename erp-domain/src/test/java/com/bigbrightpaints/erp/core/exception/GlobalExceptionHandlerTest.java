...
class GlobalExceptionHandlerTest {
  ...
  @Test
  void accessDenied_usesPortalRoleActionMessageWhenAvailable() {
  ...
  @Test
  void accessDenied_marksRequestAsAuditedWhenCanonicalAuditRuns() throws Exception {
    SecurityContextHolder.getContext()
        .setAuthentication(
            new UsernamePasswordAuthenticationToken(
                "accounting.user", "N/A", List.of(new SimpleGrantedAuthority("ROLE_ACCOUNTING"))));
  ...
  @Test
  void authenticationException_usesLockedContractForLockedUsers() {
    GlobalExceptionHandler handler = new GlobalExceptionHandler();
  ...
  @Test
  void mfaExceptions_returnCanonicalAuthResponses() {
    GlobalExceptionHandler handler = new GlobalExceptionHandler();
    MockHttpServletRequest request = new MockHttpServletRequest("POST", "/api/v1/auth/login");
    request.setRequestURI("/api/v1/auth/login");
  ...
  @Test
  void authSecurityContract_preservesExplicitStatusAndDetails() {
    GlobalExceptionHandler handler = new GlobalExceptionHandler();
  ...
  @Test
  void dataIntegrityViolation_mapsDuplicateConflicts() {
    GlobalExceptionHandler handler = new GlobalExceptionHandler();
  ...
  @Test
  void illegalState_redactsInternalMessageFromResponse() {
    GlobalExceptionHandler handler = new GlobalExceptionHandler();
  ...
  @Test
  void runtimeException_redactsInternalMessageFromResponse() {
    GlobalExceptionHandler handler = new GlobalExceptionHandler();
