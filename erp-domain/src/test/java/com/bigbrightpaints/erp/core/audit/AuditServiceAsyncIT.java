...
class AuditServiceAsyncIT {
    ...
    @Test
    void logAuthSuccess_asyncProxyPreservesExplicitAttributionAfterContextMutation() throws Exception {
        ...
        callerContext.setAuthentication(new UsernamePasswordAuthenticationToken("ambient-before", "n/a"));
        ...
        auditService.logAuthSuccess(
                ...
                "explicit-user",
                "COMP-ASYNC",
                Map.of("origin", "async-it"));

        callerContext.setAuthentication(new UsernamePasswordAuthenticationToken("ambient-mutated", "n/a"));
