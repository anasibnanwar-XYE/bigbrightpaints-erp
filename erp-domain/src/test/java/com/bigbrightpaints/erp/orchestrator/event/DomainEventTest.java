...
class DomainEventTest {
  ...
  void of_populatesFields() {
    DomainEvent event =
        DomainEvent.of(
            "CREATED", "COMP", "USER", "ORDER", "1", "payload", "trace-1", "req-1", "idem-1");
  ...
  void of_generatesUniqueIds() {
    DomainEvent first =
        DomainEvent.of("CREATED", "COMP", "USER", "ORDER", "1", null, "trace-1", "req-1", "idem-1");
    DomainEvent second =
        DomainEvent.of("CREATED", "COMP", "USER", "ORDER", "1", null, "trace-2", "req-2", "idem-2");
