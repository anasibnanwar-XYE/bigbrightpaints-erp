...
class OrderAutoApprovalListenerTest {
  ...
  void onOrderCreated_skipsWhenAutoApprovalDisabled() {
    ...
    OrderAutoApprovalListener listener =
        new OrderAutoApprovalListener(commandDispatcher, salesService, systemSettingsService);
  ...
  void onOrderCreated_autoApprovesAndAttachesTraceIdWhenEnabled() {
    ...
    when(commandDispatcher.autoApproveOrder(
            "42", new BigDecimal("100.00"), "COMP", "AUTO-APPROVE-42", "AUTO-APPROVE-42"))
