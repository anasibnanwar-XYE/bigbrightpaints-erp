...
class CreditLimitRequestDecisionRequestTest {
  ...
  void canonicalConstructor_exposesReasonAccessor() {
    CreditLimitRequestDecisionRequest request =
        new CreditLimitRequestDecisionRequest("Risk cleared by finance");
  ...
  void toString_includesRecordComponentValue() {
    CreditLimitRequestDecisionRequest request =
        new CreditLimitRequestDecisionRequest("Manual override");
