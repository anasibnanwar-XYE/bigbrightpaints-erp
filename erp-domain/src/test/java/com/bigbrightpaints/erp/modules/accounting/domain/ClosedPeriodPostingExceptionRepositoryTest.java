...
class ClosedPeriodPostingExceptionRepositoryTest extends AbstractIntegrationTest {
  ...
  @Autowired private ClosedPeriodPostingExceptionRepository repository;
  ...
  void findByCompanyAndDocumentTypeAndReference_ordersNewestFirstCaseInsensitively() {
    ...
    ClosedPeriodPostingException older =
        persistException(
            company, period, "sales_return", "sr-1001", Instant.parse("2026-03-12T10:00:00Z"));
    ClosedPeriodPostingException newer =
        persistException(
            company, period, "SALES_RETURN", "SR-1001", Instant.parse("2026-03-12T11:00:00Z"));
    ...
    assertThat(results)
        .extracting(ClosedPeriodPostingException::getId)
  ...
  private ClosedPeriodPostingException persistException(
      Company company,
