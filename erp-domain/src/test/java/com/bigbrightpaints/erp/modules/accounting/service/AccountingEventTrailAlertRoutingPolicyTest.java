...
class AccountingEventTrailAlertRoutingPolicyTest {
  ...
  void resolveRoute_mapsKnownFailureCategoryPolicyCombinations(
      String failureCode, String errorCategory, String policy, String expectedRoute) {
    assertThat(
  ...
  void resolveRoute_unknownCategoryFallsBackToSev3Ticket() {
    assertThat(
            AccountingEventTrailAlertRoutingPolicy.resolveRoute(
                AccountingEventTrailAlertRoutingPolicy.ACCOUNTING_EVENT_TRAIL_FAILURE_CODE,
                "SOMETHING_NEW",
                "STRICT"))
        .isEqualTo(AccountingEventTrailAlertRoutingPolicy.ROUTE_SEV3_TICKET);
  }
  ...
  void resolveRoute_nonContractFailureCodeIsUnmapped() {
    assertThat(
            AccountingEventTrailAlertRoutingPolicy.resolveRoute(
                "ANOTHER_FAILURE_CODE", "DATA_INTEGRITY", "STRICT"))
        .isEqualTo(AccountingEventTrailAlertRoutingPolicy.ROUTE_UNMAPPED);
  }
}
