  ...
  void equalsAndHashCodeFollowValueSemantics() {
    ...
    CreditLimitRequestDto same =
        new CreditLimitRequestDto(
            ...
            "Need durable increase",
            createdAt);
    CreditLimitRequestDto different =
        new CreditLimitRequestDto(
            902L,
            publicId,
            "Dealer Two",
    ...
    CreditLimitRequestDto differentPublicId =
        new CreditLimitRequestDto(
            901L,
            ...
            "Need durable increase",
            createdAt);
    CreditLimitRequestDto differentDealerName =
        new CreditLimitRequestDto(
            901L,
            publicId,
            "Dealer Two",
            ...
            "Need durable increase",
            createdAt);
    CreditLimitRequestDto differentAmount =
        new CreditLimitRequestDto(
            901L,
            publicId,
            "Dealer One",
            ...
            "Need durable increase",
            createdAt);
    CreditLimitRequestDto differentStatus =
        new CreditLimitRequestDto(
            901L,
            publicId,
            "Dealer One",
            ...
            "Need durable increase",
            createdAt);
    CreditLimitRequestDto differentReason =
        new CreditLimitRequestDto(
            901L,
            publicId,
            "Dealer One",
            ...
            "Different",
            createdAt);
    CreditLimitRequestDto differentCreatedAt =
        new CreditLimitRequestDto(
            901L,
            publicId,
            "Dealer One",
