...
class ReportControllerContractTest {
  ...
  void dealerAging_delegatesToCanonicalAgingService() {
    ...
    ReportController controller =
        new ReportController(
            ...
            agingReportService,
            exportApprovalService);
    AgingReportService.DealerAgingDetail expected =
        new AgingReportService.DealerAgingDetail(
            77L, "DLR-77", "Dealer 77", new AgingReportService.AgingBuckets(), BigDecimal.ZERO);
    when(agingReportService.getDealerAging(77L)).thenReturn(expected);

    ResponseEntity<ApiResponse<AgingReportService.DealerAgingDetail>> response =
        controller.dealerAging(77L);
  ...
  void dealerAgingDetailed_delegatesToCanonicalAgingService() {
    ...
    ReportController controller =
        new ReportController(
            ...
            agingReportService,
            exportApprovalService);
    AgingReportService.DealerAgingDetailedReport expected =
        new AgingReportService.DealerAgingDetailedReport(
            77L,
            "DLR-77",
            "Dealer 77",
            List.of(),
  ...
  void dealerDso_delegatesToCanonicalAgingService() {
    ...
    ReportController controller =
        new ReportController(
            ...
            agingReportService,
            exportApprovalService);
    AgingReportService.DSOReport expected =
        new AgingReportService.DSOReport(77L, "Dealer 77", 12.5, BigDecimal.ZERO, 0, 0L);
  ...
  void dealerAging_unknownDealerUsesGlobalNotFoundContractOnCanonicalReportHost() throws Exception {
    AgingReportService agingReportService = mock(AgingReportService.class);
    when(agingReportService.getDealerAging(404L))
        .thenThrow(
