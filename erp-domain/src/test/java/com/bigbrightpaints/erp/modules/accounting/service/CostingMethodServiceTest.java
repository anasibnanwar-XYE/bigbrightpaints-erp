...
class CostingMethodServiceTest {
  ...
  void resolveActiveMethodForCurrentCompany_usesPeriodCostingMethod() {
    ...
    CostingMethodService service =
        new CostingMethodService(accountingPeriodService, companyContextService);

    assertThat(service.resolveActiveMethodForCurrentCompany(referenceDate))
        .isEqualTo(CostingMethod.LIFO);
  }
