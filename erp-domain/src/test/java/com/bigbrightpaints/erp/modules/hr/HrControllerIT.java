...
public class HrControllerIT extends AbstractIntegrationTest {
  ...
  void seed() {
    dataSeeder.ensureUser(
        ADMIN_EMAIL, ADMIN_PASSWORD, "HR Admin", COMPANY_CODE, List.of("ROLE_ADMIN"));
  ...
  void employeeLifecycle_and_payroll_run() {
    ...
    Map<String, Object> employeeRequest =
        Map.ofEntries(
    ...
    ResponseEntity<Map> createEmployee =
        rest.exchange(
            "/api/v1/hr/employees",
            HttpMethod.POST,
    ...
    Map<String, Object> payrollRequest =
        Map.of(
            "runType",
            "WEEKLY",
            "periodStart",
    ...
    ResponseEntity<Map> payrollResp =
        rest.exchange(
            "/api/v1/payroll/runs",
            HttpMethod.POST,
    ...
    ResponseEntity<Map> employees =
        rest.exchange("/api/v1/hr/employees", HttpMethod.GET, new HttpEntity<>(headers), Map.class);
    ...
    ResponseEntity<Map> payrollRuns =
        rest.exchange(
            "/api/v1/hr/payroll-runs", HttpMethod.GET, new HttpEntity<>(headers), Map.class);
    ...
    ResponseEntity<Map> legacyCreatePayroll =
        rest.exchange(
