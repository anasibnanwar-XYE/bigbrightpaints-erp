...
class SalesTargetRequestTest {
    ...
    void canonicalConstructor_exposesAllAccessors() {
        SalesTargetRequest request = new SalesTargetRequest(
                "Q1 Dealer Growth",
    ...
    void equalsAndHashCode_sameFieldValues_areEqual() {
        SalesTargetRequest one = new SalesTargetRequest(
                "Q2 Dealer Growth",
        ...
        SalesTargetRequest two = new SalesTargetRequest(
                "Q2 Dealer Growth",
                LocalDate.of(2026, 4, 1),
                LocalDate.of(2026, 6, 30),
                new BigDecimal("200000.00"),
    ...
    void equalsAndHashCode_whenAnyComponentDiffers_areNotEqual() {
        SalesTargetRequest baseline = new SalesTargetRequest(
                "Q3 Dealer Growth",
        ...
        SalesTargetRequest differentAssignee = new SalesTargetRequest(
                "Q3 Dealer Growth",
                LocalDate.of(2026, 7, 1),
                LocalDate.of(2026, 9, 30),
                new BigDecimal("175000.00"),
