...
class JournalLineRepositoryIT extends AbstractIntegrationTest {
    ...
    void summarizeTotalsByCompanyAndJournalEntryIds_isTenantScoped() {
        ...
        List<JournalLineRepository.JournalEntryLineTotals> totals = journalLineRepository
                .summarizeTotalsByCompanyAndJournalEntryIds(companyA, List.of(entryA.getId(), entryB.getId()));
