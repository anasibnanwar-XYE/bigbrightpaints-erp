...
class CreditLimitRequestCreateRequestTest {
  ...
  void accessorsAndJsonCreatorPreservePayload() throws Exception {
    ...
    assertThat(request.toString())
        .contains("dealerId=17", "amountRequested=1500.50", "reason=Need durable increase");
  }
  ...
  void equalsAndHashCodeFollowValueSemantics() {
    CreditLimitRequestCreateRequest request =
        new CreditLimitRequestCreateRequest(
            17L, new BigDecimal("1500.50"), "Need durable increase");
    CreditLimitRequestCreateRequest same =
        new CreditLimitRequestCreateRequest(
            17L, new BigDecimal("1500.50"), "Need durable increase");
    CreditLimitRequestCreateRequest different =
        new CreditLimitRequestCreateRequest(18L, new BigDecimal("800.00"), "Different");
    CreditLimitRequestCreateRequest differentAmount =
        new CreditLimitRequestCreateRequest(17L, new BigDecimal("800.00"), "Need durable increase");
    CreditLimitRequestCreateRequest differentReason =
        new CreditLimitRequestCreateRequest(17L, new BigDecimal("1500.50"), "Different");
