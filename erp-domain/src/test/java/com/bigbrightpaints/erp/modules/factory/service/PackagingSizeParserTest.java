...
class PackagingSizeParserTest {
  ...
  void parseSizeInLitersRejectsInvalidValues() {
    assertThat(PackagingSizeParser.parseSizeInLiters("SIZE")).isNull();
    assertThat(PackagingSizeParser.parseSizeInLiters("1")).isNull();
    assertThat(PackagingSizeParser.parseSizeInLiters("abc1L")).isNull();
  }
}
