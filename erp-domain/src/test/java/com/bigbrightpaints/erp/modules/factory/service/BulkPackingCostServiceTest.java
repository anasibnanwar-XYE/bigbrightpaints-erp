...
class BulkPackingCostServiceTest {
  ...
  void consumePackagingIfRequired_usesPackagingMappingsAndTracksPerLineCosts() {
    ...
    BulkPackCostSummary summary =
        bulkPackingCostService.consumePackagingIfRequired(
            company,
            new BulkPackRequest(
                41L,
  ...
  void consumePackagingIfRequired_returnsEmptySummaryWhenRequestMissing() {
    BulkPackCostSummary summary =
        bulkPackingCostService.consumePackagingIfRequired(company, null, "PACK-REF");
  ...
  void createCostingContext_usesTotalPackagingCostFallbackPerPack() {
    BulkPackCostSummary summary =
        new BulkPackCostSummary(
            new BigDecimal("12.00"), Map.of(10L, new BigDecimal("12.00")), Map.of());

    BulkPackCostingContext context =
        bulkPackingCostService.createCostingContext(new BigDecimal("4.50"), summary, 6);
