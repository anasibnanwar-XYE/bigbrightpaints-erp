...
class TimeDateSafetyTest extends AbstractIntegrationTest {
  ...
  void businessDates_comeFromCompanyClock_andAlignAcrossModules() {
    String companyCode = "RISK-DATE-" + shortId();
  ...
  private void seedPayrollLine(Company company, PayrollRun run) {
    String email = "risk-" + company.getCode().toLowerCase() + "@example.com";
    Employee employee =
        employeeRepository
