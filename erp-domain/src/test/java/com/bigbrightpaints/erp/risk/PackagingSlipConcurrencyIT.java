...
@Tag("critical")
@Tag("concurrency")
class PackagingSlipConcurrencyIT extends AbstractIntegrationTest {
  ...
  void reserveForOrder_concurrentCalls_createSinglePrimarySlip() {
    Company company =
        dataSeeder.ensureCompany("RISK-PS-CONC-" + shortId(), "CR Packaging Slip Concurrency");
    ...
    RiskConcurrencyHarness.RunResult<FinishedGoodsService.InventoryReservationResult> result =
