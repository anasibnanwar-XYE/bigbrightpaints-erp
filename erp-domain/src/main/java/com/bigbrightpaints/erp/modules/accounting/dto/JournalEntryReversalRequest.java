...
public record JournalEntryReversalRequest(
    ...
    public JournalEntryReversalRequest(LocalDate reversalDate, boolean voidOnly, String reason, 
                                       String memo, Boolean adminOverride) {
        this(reversalDate, voidOnly, reason, memo, adminOverride, 
    ...
    public boolean isPartialReversal() {
        return reversalPercentage != null && 
               reversalPercentage.compareTo(new BigDecimal("100.00")) < 0;
    }
