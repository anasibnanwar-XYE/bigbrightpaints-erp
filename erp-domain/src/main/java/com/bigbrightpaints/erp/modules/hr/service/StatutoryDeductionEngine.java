...
public class StatutoryDeductionEngine {
  ...
  public BigDecimal calculatePfDeduction(BigDecimal basicComponent, Employee employee) {
    ...
    SalaryStructureTemplate template =
        employee != null ? employee.getSalaryStructureTemplate() : null;
    BigDecimal pfRate =
        template != null && template.getEmployeePfRate() != null
  ...
  public BigDecimal calculateEsiDeduction(BigDecimal grossPay, Employee employee) {
    ...
    SalaryStructureTemplate template =
        employee != null ? employee.getSalaryStructureTemplate() : null;
    BigDecimal esiRate =
        template != null && template.getEmployeeEsiRate() != null
  ...
  public BigDecimal calculateTdsDeduction(BigDecimal grossPay, PayrollRun run, Employee employee) {
    ...
    Employee.TaxRegime regime =
        employee != null && employee.getTaxRegime() != null
            ? employee.getTaxRegime()
            : Employee.TaxRegime.NEW;
    BigDecimal annualExemption =
        regime == Employee.TaxRegime.OLD ? OLD_REGIME_EXEMPTION : NEW_REGIME_EXEMPTION;
