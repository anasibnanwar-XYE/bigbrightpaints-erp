...
public class HrController {
  ...
  public HrController(
      HrService hrService, CompanyContextService companyContextService, CompanyClock companyClock) {
  ...
  public ResponseEntity<ApiResponse<EmployeeDto>> createEmployee(
    ...
    return ResponseEntity.ok(
        ApiResponse.success("Employee created", hrService.createEmployee(request)));
  }
  ...
  public ResponseEntity<ApiResponse<EmployeeDto>> updateEmployee(
    ...
    return ResponseEntity.ok(
        ApiResponse.success("Employee updated", hrService.updateEmployee(id, request)));
  }
  ...
  public ResponseEntity<ApiResponse<List<SalaryStructureTemplateDto>>> listSalaryStructures() {
    return ResponseEntity.ok(
        ApiResponse.success(
            "Salary structure templates", hrService.listSalaryStructureTemplates()));
  }
  ...
  public ResponseEntity<ApiResponse<SalaryStructureTemplateDto>> createSalaryStructure(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            "Salary structure template created", hrService.createSalaryStructureTemplate(request)));
  }

  @PutMapping("/salary-structures/{id}")
  public ResponseEntity<ApiResponse<SalaryStructureTemplateDto>> updateSalaryStructure(
      @PathVariable Long id, @Valid @RequestBody SalaryStructureTemplateRequest request) {
    return ResponseEntity.ok(
        ApiResponse.success(
            "Salary structure template updated",
  ...
  public ResponseEntity<ApiResponse<LeaveRequestDto>> createLeaveRequest(
    ...
    return ResponseEntity.ok(
        ApiResponse.success("Leave request created", hrService.createLeaveRequest(request)));
  }

  @PatchMapping("/leave-requests/{id}/status")
  public ResponseEntity<ApiResponse<LeaveRequestDto>> updateLeaveStatus(
      @PathVariable Long id, @Valid @RequestBody LeaveStatusUpdateRequest request) {
    return ResponseEntity.ok(
        ApiResponse.success("Status updated", hrService.updateLeaveStatus(id, request)));
  }
  ...
  public ResponseEntity<ApiResponse<List<LeaveBalanceDto>>> leaveBalances(
    ...
    return ResponseEntity.ok(
        ApiResponse.success("Leave balances", hrService.getLeaveBalances(employeeId, year)));
  }
  ...
  public ResponseEntity<ApiResponse<List<MonthlyAttendanceSummaryDto>>> monthlyAttendanceSummary(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            "Monthly attendance summary", hrService.getMonthlyAttendanceSummary(year, month)));
  }
  ...
  public ResponseEntity<ApiResponse<List<AttendanceDto>>> employeeAttendance(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(hrService.listEmployeeAttendance(employeeId, startDate, endDate)));
  }

  @PostMapping("/attendance/mark/{employeeId}")
  public ResponseEntity<ApiResponse<AttendanceDto>> markAttendance(
      @PathVariable Long employeeId, @Valid @RequestBody MarkAttendanceRequest request) {
    return ResponseEntity.ok(
        ApiResponse.success("Attendance marked", hrService.markAttendance(employeeId, request)));
  }
  ...
  public ResponseEntity<ApiResponse<List<AttendanceDto>>> bulkMarkAttendance(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            "Attendance marked for " + request.employeeIds().size() + " employees",
