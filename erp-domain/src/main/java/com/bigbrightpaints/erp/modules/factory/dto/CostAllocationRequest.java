...
public record CostAllocationRequest(
    ...
    @NotNull(message = "Month is required")
        ...
        Integer month,
    @NotNull(message = "Labor cost is required") BigDecimal laborCost,
    @NotNull(message = "Overhead cost is required") BigDecimal overheadCost,
    @NotNull(message = "Finished goods account is required") Long finishedGoodsAccountId,
    @NotNull(message = "Labor expense account is required") Long laborExpenseAccountId,
    @NotNull(message = "Overhead expense account is required") Long overheadExpenseAccountId,
    String notes) {
