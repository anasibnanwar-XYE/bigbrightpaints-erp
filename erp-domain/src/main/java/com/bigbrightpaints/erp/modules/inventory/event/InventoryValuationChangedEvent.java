...
public record InventoryValuationChangedEvent(
  ...
  public static class Builder {
    ...
    public Builder inventoryType(InventoryType type) {
    ...
    public Builder inventoryAccountId(Long id) {
      this.inventoryAccountId = id;
      return this;
    }

    public Builder oldValue(BigDecimal val) {
      this.oldValue = val;
      return this;
    }

    public Builder newValue(BigDecimal val) {
      this.newValue = val;
      return this;
    }
    ...
    public Builder oldUnitCost(BigDecimal cost) {
      this.oldUnitCost = cost;
      return this;
    }

    public Builder newUnitCost(BigDecimal cost) {
      this.newUnitCost = cost;
      return this;
    }

    public Builder reason(ValuationChangeReason reason) {
      this.reason = reason;
      return this;
    }
