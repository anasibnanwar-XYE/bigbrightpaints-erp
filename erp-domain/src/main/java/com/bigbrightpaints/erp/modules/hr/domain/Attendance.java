...
@Table(
    name = "attendance",
    uniqueConstraints =
        @UniqueConstraint(columnNames = {"company_id", "employee_id", "attendance_date"}),
    indexes = {
...
public class Attendance {
  ...
  public void setRegularHours(java.math.BigDecimal regularHours) {
  ...
  public java.math.BigDecimal getDoubleOvertimeHours() {
    return doubleOvertimeHours;
  }

  public void setDoubleOvertimeHours(java.math.BigDecimal doubleOvertimeHours) {
  ...
  public void setBasePay(java.math.BigDecimal basePay) {
  ...
  public void setOvertimePay(java.math.BigDecimal overtimePay) {
