...
public record CatalogProductRequest(
    ...
    @NotBlank(message = "HSN code is required") String hsnCode,
    @DecimalMin(value = "0.00", message = "Base price cannot be negative") BigDecimal basePrice,
    ...
    @DecimalMin(value = "0.00", message = "Minimum discount percent cannot be negative")
        @DecimalMax(
            value = "100.00",
            message = "Minimum discount percent cannot be greater than 100")
