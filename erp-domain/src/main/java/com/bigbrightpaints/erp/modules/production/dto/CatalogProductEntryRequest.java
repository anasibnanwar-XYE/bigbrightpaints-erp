...
public class CatalogProductEntryRequest {
  ...
  @JsonIgnore private final Map<String, Object> unknownFields = new LinkedHashMap<>();
  ...
  public List<@NotBlank(message = "colors must not contain blank values") String> getColors() {
    return colors;
  }
  ...
  public List<@NotBlank(message = "sizes must not contain blank values") String> getSizes() {
    return sizes;
  }
