...
@Table(
    ...
    uniqueConstraints = {
      @UniqueConstraint(
          ...
          columnNames = {"company_id", "sku_code"}),
      @UniqueConstraint(
          name = "uq_product_brand_name",
          columnNames = {"brand_id", "product_name"})
    })
public class ProductionProduct extends VersionedEntity {
  ...
  @ElementCollection
  @CollectionTable(
      name = "production_product_colors",
  ...
  @ElementCollection
  @CollectionTable(
      name = "production_product_carton_sizes",
      joinColumns = @JoinColumn(name = "product_id"))
