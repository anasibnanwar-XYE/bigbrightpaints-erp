...
public class SupplierApprovalPolicy {
  ...
  public SupplierApprovalDecision requireSupplierExceptionApproval(
      SupplierApprovalDecision approval) {
    SupplierApprovalDecision resolved =
        SupplierApprovalDecision.requireApproved(approval, "Supplier exception");
  ...
  public SupplierApprovalDecision requireSettlementOverrideApproval(
      SupplierApprovalDecision approval) {
    SupplierApprovalDecision resolved =
        SupplierApprovalDecision.requireApproved(approval, "Settlement override");
