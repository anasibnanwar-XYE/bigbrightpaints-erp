...
public class HrPayrollController {
  ...
  public ResponseEntity<ApiResponse<List<PayrollRunLineDto>>> getPayrollRunLines(
      @PathVariable Long id) {
    return ResponseEntity.ok(
        ApiResponse.success("Payroll run lines", payrollService.getPayrollRunLines(id)));
  }
  ...
  public ResponseEntity<ApiResponse<PayrollRunDto>> createPayrollRun(
    ...
    return ResponseEntity.ok(
        ApiResponse.success("Payroll run created", payrollService.createPayrollRun(request)));
  }
  ...
  public ResponseEntity<ApiResponse<PayrollRunDto>> createWeeklyPayrollRun(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            "Weekly payroll run created", payrollService.createWeeklyPayrollRun(weekEndingDate)));
  }
  ...
  public ResponseEntity<ApiResponse<PayrollRunDto>> createMonthlyPayrollRun(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            "Monthly payroll run created", payrollService.createMonthlyPayrollRun(year, month)));
  }
  ...
  public ResponseEntity<ApiResponse<PayrollRunDto>> calculatePayroll(@PathVariable Long id) {
    return ResponseEntity.ok(
        ApiResponse.success("Payroll calculated", payrollService.calculatePayroll(id)));
  }
  ...
  public ResponseEntity<ApiResponse<PayrollRunDto>> approvePayroll(@PathVariable Long id) {
    return ResponseEntity.ok(
        ApiResponse.success("Payroll approved", payrollService.approvePayroll(id)));
  }
  ...
  public ResponseEntity<ApiResponse<PayrollRunDto>> postPayroll(@PathVariable Long id) {
    return ResponseEntity.ok(
        ApiResponse.success(
            "Payroll posted to accounting", payrollService.postPayrollToAccounting(id)));
  }
  ...
  public ResponseEntity<ApiResponse<PayrollRunDto>> markAsPaid(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            "Payroll marked as paid", payrollService.markAsPaid(id, paymentReference)));
  }
  ...
  public ResponseEntity<ApiResponse<WeeklyPaySummaryDto>> getWeeklyPaySummary(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            "Weekly pay summary", payrollService.getWeeklyPaySummary(weekEndingDate)));
  }
  ...
  public ResponseEntity<ApiResponse<MonthlyPaySummaryDto>> getMonthlyPaySummary(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            "Monthly pay summary", payrollService.getMonthlyPaySummary(year, month)));
  }
  ...
  public ResponseEntity<ApiResponse<WeeklyPaySummaryDto>> getCurrentWeekPaySummary() {
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            "Current week pay summary", payrollService.getWeeklyPaySummary(saturday)));
  }
