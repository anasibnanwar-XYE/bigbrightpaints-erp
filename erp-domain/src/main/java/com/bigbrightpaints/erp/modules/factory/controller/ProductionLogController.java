...
public class ProductionLogController {
  ...
  @PostMapping
  public ResponseEntity<ApiResponse<ProductionLogDetailDto>> create(
      @Valid @RequestBody ProductionLogRequest request) {
    return ResponseEntity.ok(
        ApiResponse.success("Production logged", productionLogService.createLog(request)));
  }
