...
@Table(
    name = "finished_goods",
    uniqueConstraints = @UniqueConstraint(columnNames = {"company_id", "product_code"}))
public class FinishedGood extends VersionedEntity {
  ...
  public void setReservedStock(BigDecimal reservedStock) {
    if (reservedStock == null) {
      ...
      throw new IllegalArgumentException(
          "Reserved stock cannot be negative for product " + productCode);
    } else {
  ...
  public Long getValuationAccountId() {
    return valuationAccountId;
  }

  public void setValuationAccountId(Long valuationAccountId) {
    this.valuationAccountId = valuationAccountId;
  }
  ...
  public void setLowStockThreshold(BigDecimal lowStockThreshold) {
    if (lowStockThreshold == null) {
      ...
      throw new IllegalArgumentException(
          "Low stock threshold cannot be negative for product " + productCode);
    } else {
  ...
  public void adjustStock(BigDecimal quantityDelta, String operation) {
    BigDecimal newStock =
        (currentStock == null ? BigDecimal.ZERO : currentStock).add(quantityDelta);
