...
public class ReportQuerySupport {
  ...
  public FinancialQueryWindow resolveWindow(FinancialReportQueryRequest request) {
    ...
    LocalDate effectiveAsOf =
        request.asOfDate() != null ? request.asOfDate() : companyClock.today(company);
    ...
    if (startDate != null && endDate != null) {
        ...
        periodForWindow =
            accountingPeriodRepository
                .findByCompanyAndYearAndMonth(
                    company, startDate.getYear(), startDate.getMonthValue())
                .orElse(null);
      }
      ...
      periodForWindow =
          accountingPeriodRepository
              .findByCompanyAndYearAndMonth(
                  company, effectiveAsOf.getYear(), effectiveAsOf.getMonthValue())
              .orElse(null);
    }
    ...
    if (periodForWindow != null && periodForWindow.getStatus() == AccountingPeriodStatus.CLOSED) {
      ...
      Optional<AccountingPeriodSnapshot> snapshotCandidate =
          snapshotRepository.findByCompanyAndPeriod(company, periodForWindow);
  ...
  public FinancialComparisonWindow resolveComparison(FinancialReportQueryRequest request) {
    ...
    FinancialReportQueryRequest comparisonRequest =
  ...
  private ExportOptions resolveExportOptions(String exportFormat) {
    ...
    return switch (normalized) {
      ...
      default ->
          throw new ApplicationException(
              ErrorCode.VALIDATION_INVALID_INPUT, "Unsupported exportFormat: " + exportFormat);
    };
  }
  ...
  public record ExportOptions(boolean pdfReady, boolean csvReady, String requestedFormat) {}
  ...
  public record FinancialComparisonWindow(FinancialQueryWindow window) {}
}
