...
public class PackingCompletionService {
  ...
  public PackingCompletionService(
      PackingProductSupport packingProductSupport, AccountingFacade accountingFacade) {
    this.packingProductSupport = packingProductSupport;
    this.accountingFacade = accountingFacade;
  }

  public void postCompletionEntries(
      Company company,
      ProductionLog log,
    ...
    BigDecimal materialUnitCost =
        calculateUnitCost(log.getMaterialCostTotal(), log.getMixedQuantity());
    ...
    BigDecimal wastageValue =
        MoneyUtils.safeMultiply(baseUnitCost, wastageQty).setScale(2, COST_ROUNDING);
