...
public class TenantLifecycleService {
    ...
    public CompanyLifecycleStateDto transition(Company company,
        ...
        CompanyLifecycleState targetState = requestedState == null
    ...
    void validateTransition(CompanyLifecycleState previousState, CompanyLifecycleState nextState) {
        ...
        boolean allowed = switch (previousState) {
            case ACTIVE -> nextState == CompanyLifecycleState.SUSPENDED || nextState == CompanyLifecycleState.DEACTIVATED;
            case SUSPENDED -> nextState == CompanyLifecycleState.ACTIVE || nextState == CompanyLifecycleState.DEACTIVATED;
    ...
    private void auditTransition(Company company,
