...
public record InventoryMovementEvent(
  ...
  public static class Builder {
    ...
    public Builder companyId(Long id) {
      this.companyId = id;
      return this;
    }
    ...
    public Builder inventoryType(InventoryValuationChangedEvent.InventoryType type) {
      this.inventoryType = type;
      return this;
    }

    public Builder itemId(Long id) {
      this.itemId = id;
      return this;
    }
    ...
    public Builder unitCost(BigDecimal cost) {
      this.unitCost = cost;
      return this;
    }
    ...
    public Builder destinationAccountId(Long id) {
      this.destinationAccountId = id;
      return this;
    }

    public Builder movementId(Long id) {
      this.movementId = id;
      return this;
    }
    ...
    public Builder movementDate(LocalDate date) {
    ...
    public Builder relatedEntityId(Long id) {
      this.relatedEntityId = id;
      return this;
    }

    public Builder relatedEntityType(String type) {
    ...
    public InventoryMovementEvent build() {
      ...
      return new InventoryMovementEvent(
          ...
          movementId,
          referenceNumber,
          movementDate != null ? movementDate : CompanyTime.today(),
          memo,
          relatedEntityId,
          relatedEntityType,
          CompanyTime.now());
