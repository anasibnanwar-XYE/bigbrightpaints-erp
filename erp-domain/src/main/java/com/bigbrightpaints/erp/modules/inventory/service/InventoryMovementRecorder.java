...
public class InventoryMovementRecorder {
  ...
  public InventoryMovementRecorder(
  ...
  public InventoryMovement recordFinishedGoodMovement(
    ...
    publishMovementEventIfSupported(
        finishedGood, saved, referenceType, referenceId, movementType, quantity, unitCost);
    return saved;
  }

  private void publishMovementEventIfSupported(
      FinishedGood finishedGood,
      ...
      BigDecimal quantity,
      BigDecimal unitCost) {
    InventoryMovementEvent.MovementType eventType =
        switch (movementType) {
