...
public record EnterpriseDashboardSnapshot(
  ...
  public record Ratios(
      Double grossMarginPct, Double overduePct, Double inventoryTurns, Double onTimeDispatchPct) {}
  ...
  public record Breakdown(
      List<TopDealer> topDealers, List<TopSku> topSkus, List<OverdueInvoice> overdueInvoices) {}
