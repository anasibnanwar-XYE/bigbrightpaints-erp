...
public interface PeriodCloseRequestRepository extends JpaRepository<PeriodCloseRequest, Long> {
    ...
    @Query("""
            ...
            """)
    List<PeriodCloseRequest> findPendingByCompanyOrderByRequestedAtDesc(@Param("company") Company company);

    List<PeriodCloseRequest> findByCompanyAndStatusOrderByRequestedAtDesc(Company company,
                                                                           PeriodCloseRequestStatus status);

    Optional<PeriodCloseRequest> findByCompanyAndAccountingPeriodAndStatus(Company company,
    ...
    @Query("""
            ...
            """)
    Optional<PeriodCloseRequest> lockByCompanyAndAccountingPeriodAndStatus(@Param("company") Company company,
    ...
    @Query("""
            ...
            """)
    Optional<PeriodCloseRequest> lockByCompanyAndId(@Param("company") Company company,
    ...
    List<PeriodCloseRequest> findByCompanyAndAccountingPeriodOrderByRequestedAtDesc(
            ...
            @Param("period") AccountingPeriod period);
}
