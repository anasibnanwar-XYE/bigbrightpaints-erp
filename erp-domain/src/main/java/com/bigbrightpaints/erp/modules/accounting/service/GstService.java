...
public class GstService {
    ...
    public GstBreakdown calculateGst(BigDecimal amount,
                                     String sourceState,
                                     String destState,
                                     BigDecimal gstRate) {
        ...
        BigDecimal totalTax = MoneyUtils.roundCurrency(
    ...
    public GstBreakdown splitTaxAmount(BigDecimal taxableAmount,
                                       BigDecimal totalTax,
                                       String sourceState,
                                       String destState) {
    ...
    private GstBreakdown splitTaxAmount(BigDecimal taxableAmount,
                                        BigDecimal totalTax,
                                        String sourceState,
                                        String destState,
                                        TaxType taxType) {
        ...
        BigDecimal cgst = MoneyUtils.roundCurrency(roundedTax.divide(new BigDecimal("2"), 6, RoundingMode.HALF_UP));
