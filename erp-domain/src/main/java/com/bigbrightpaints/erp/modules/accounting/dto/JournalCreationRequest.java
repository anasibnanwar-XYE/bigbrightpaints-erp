          ...
          .map(
              line ->
                  new JournalEntryRequest.JournalLineRequest(
                      line.accountId(), line.narration(), line.debit(), line.credit()))
          .toList();
    }
    List<JournalEntryRequest.JournalLineRequest> generated = new ArrayList<>();
    generated.add(
        new JournalEntryRequest.JournalLineRequest(
            debitAccount, narration, amount, BigDecimal.ZERO));
    generated.add(
        new JournalEntryRequest.JournalLineRequest(
            creditAccount, narration, BigDecimal.ZERO, amount));
    return generated;
  }

  public record LineRequest(
      Long accountId, BigDecimal debit, BigDecimal credit, String narration) {}
