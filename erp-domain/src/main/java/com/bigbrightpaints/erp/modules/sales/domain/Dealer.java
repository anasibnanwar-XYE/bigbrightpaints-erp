...
public class Dealer extends VersionedEntity {
  ...
  public DealerPaymentTerms getPaymentTerms() {
    return paymentTerms;
  }
  ...
  public UserAccount getPortalUser() {
    return portalUser;
  }

  public void setPortalUser(UserAccount portalUser) {
  ...
  public boolean equals(Object o) {
    ...
    Long thisId =
        this instanceof HibernateProxy proxy
            ...
            : getId();
    Long otherId =
        dealer instanceof HibernateProxy proxy
            ? (Long) proxy.getHibernateLazyInitializer().getIdentifier()
            : dealer.getId();
