...
public class PayrollRunLine {
    ...
    public void setHalfDays(BigDecimal halfDays) { this.halfDays = halfDays; }
    ...
    public BigDecimal getDoubleOtHours() { return doubleOtHours; }
    public void setDoubleOtHours(BigDecimal doubleOtHours) { this.doubleOtHours = doubleOtHours; }
    public BigDecimal getDailyRate() { return dailyRate; }
    public void setDailyRate(BigDecimal dailyRate) { this.dailyRate = dailyRate; }
    public BigDecimal getHourlyRate() { return hourlyRate; }
    public void setHourlyRate(BigDecimal hourlyRate) { this.hourlyRate = hourlyRate; }
    public BigDecimal getOtRateMultiplier() { return otRateMultiplier; }
    public void setOtRateMultiplier(BigDecimal otRateMultiplier) { this.otRateMultiplier = otRateMultiplier; }
    public BigDecimal getDoubleOtMultiplier() { return doubleOtMultiplier; }
    public void setDoubleOtMultiplier(BigDecimal doubleOtMultiplier) { this.doubleOtMultiplier = doubleOtMultiplier; }
