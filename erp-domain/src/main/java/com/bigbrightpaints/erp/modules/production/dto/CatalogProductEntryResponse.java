...
public record CatalogProductEntryResponse(
  ...
  public record DownstreamEffects(int finishedGoodMembers, int rawMaterialMembers) {}
  ...
  public record Conflict(
      String sku, String reason, String productName, String itemClass, String color, String size) {}
}
