...
public class Employee extends VersionedEntity {
  ...
  public Integer getWeeklyOffDays() {
    return weeklyOffDays != null ? weeklyOffDays : 1;
  }
  ...
  public SalaryStructureTemplate getSalaryStructureTemplate() {
    return salaryStructureTemplate;
  }

  public void setSalaryStructureTemplate(SalaryStructureTemplate salaryStructureTemplate) {
    this.salaryStructureTemplate = salaryStructureTemplate;
  }
  ...
  public String getBankNameEncrypted() {
    return bankNameEncrypted;
  }

  public void setBankNameEncrypted(String bankNameEncrypted) {
    this.bankNameEncrypted = bankNameEncrypted;
  }

  public String getIfscCodeEncrypted() {
    return ifscCodeEncrypted;
  }

  public void setIfscCodeEncrypted(String ifscCodeEncrypted) {
    this.ifscCodeEncrypted = ifscCodeEncrypted;
  }
  ...
  public BigDecimal getAdvanceBalance() {
    return advanceBalance != null ? advanceBalance : BigDecimal.ZERO;
  }
  ...
  public BigDecimal getOvertimeRateMultiplier() {
    return overtimeRateMultiplier != null ? overtimeRateMultiplier : new BigDecimal("1.5");
  }
  ...
  public BigDecimal getDoubleOtRateMultiplier() {
    return doubleOtRateMultiplier != null ? doubleOtRateMultiplier : new BigDecimal("2.0");
  }

  public void setDoubleOtRateMultiplier(BigDecimal doubleOtRateMultiplier) {
    this.doubleOtRateMultiplier = doubleOtRateMultiplier;
  }
  ...
  public BigDecimal getConfiguredStandardHoursPerDay() {
  ...
  public BigDecimal calculatePay(int presentDays, int halfDays) {
    ...
    BigDecimal halfDayPay =
        dailyRate
            .multiply(new BigDecimal(halfDays))
