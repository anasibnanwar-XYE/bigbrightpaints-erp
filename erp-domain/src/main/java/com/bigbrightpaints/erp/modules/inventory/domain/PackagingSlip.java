...
@Entity
@Table(
    name = "packaging_slips",
    uniqueConstraints = @UniqueConstraint(columnNames = {"company_id", "slip_number"}))
public class PackagingSlip extends VersionedEntity {
  ...
  public String getChallanReference() {
    return challanReference;
  }

  public void setChallanReference(String challanReference) {
    this.challanReference = challanReference;
  }
  ...
  public List<PackagingSlipLine> getLines() {
    return lines;
  }
}
