...
public interface BankReconciliationSessionRepository
    extends JpaRepository<BankReconciliationSession, Long> {
  ...
  @Query(
      ...
      """)
  Page<BankReconciliationSession> findHistoryByCompany(
  ...
  @Query(
      ...
      where s.company = :company
        and s.id = :id
      """)
  Optional<BankReconciliationSession> findDetailedByCompanyAndId(
