...
public class SupportTicketController {
  ...
  public ResponseEntity<ApiResponse<SupportTicketResponse>> create(
    ...
    return ResponseEntity.ok(
        ApiResponse.success("Support ticket created", supportTicketService.create(request)));
  }
  ...
  public ResponseEntity<ApiResponse<SupportTicketListResponse>> list() {
    return ResponseEntity.ok(
        ApiResponse.success(
            "Support tickets fetched", new SupportTicketListResponse(supportTicketService.list())));
  }
  ...
  public ResponseEntity<ApiResponse<SupportTicketResponse>> getById(@PathVariable Long ticketId) {
    return ResponseEntity.ok(
        ApiResponse.success("Support ticket fetched", supportTicketService.getById(ticketId)));
  }
}
