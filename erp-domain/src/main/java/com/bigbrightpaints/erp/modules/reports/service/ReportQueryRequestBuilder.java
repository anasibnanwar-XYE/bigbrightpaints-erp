...
public final class ReportQueryRequestBuilder {
  ...
  public static FinancialReportQueryRequest fromPeriodAndRange(
      Long periodId,
      LocalDate startDate,
      LocalDate endDate,
    ...
    if (comparativeStartDate != null) {
      ValidationUtils.validateDateRange(
          comparativeStartDate, comparativeEndDate, "comparativeStartDate", "comparativeEndDate");
    }
  ...
  public static FinancialReportQueryRequest fromAsOfDate(LocalDate asOfDate) {
    return new FinancialReportQueryRequest(
        null, null, null, asOfDate, null, null, null, null, null);
  }

  public static FinancialReportQueryRequest empty() {
    return new FinancialReportQueryRequest(null, null, null, null, null, null, null, null, null);
  }
}
