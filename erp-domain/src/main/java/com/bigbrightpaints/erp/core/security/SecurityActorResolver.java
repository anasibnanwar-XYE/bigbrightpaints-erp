...
public final class SecurityActorResolver {
    ...
    private static final List<String> BACKGROUND_THREAD_PREFIXES = List.of(
            "erp-async-",
    ...
    public static String resolveActorWithSystemProcessFallback() {
        return currentAuthenticationName().orElseGet(() ->
                isBackgroundExecutionThread() ? SYSTEM_PROCESS_ACTOR : UNKNOWN_AUTH_ACTOR);
    }
