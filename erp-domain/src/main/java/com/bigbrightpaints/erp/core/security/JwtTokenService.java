  ...
  private byte[] requireStrongSecret(String secret) {
    ...
    if (bytes.length < 32) {
      throw new IllegalStateException(
          "JWT secret must be at least 256 bits; provided secret is too short");
    }
    return bytes;
  }

  public String generateAccessToken(
      String subject, String companyCode, Map<String, Object> claims) {
    return generateAccessToken(subject, companyCode, claims, Instant.now());
  }

  public String generateAccessToken(
      String subject, String companyCode, Map<String, Object> claims, Instant issuedAt) {
