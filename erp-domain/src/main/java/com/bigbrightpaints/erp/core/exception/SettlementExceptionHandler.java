...
public class SettlementExceptionHandler {
    ...
    public static final Set<String> SETTLEMENT_FAILURE_DETAIL_ALLOWLIST = Set.of(
    ...
    public boolean isSettlementRequest(HttpServletRequest request) {
        ...
        return StringUtils.hasText(requestPath) && requestPath.startsWith("/api/v1/accounting/settlements/");
    }

    public Map<String, String> buildSettlementFailureMetadata(HttpServletRequest request,
                                                              String traceId,
