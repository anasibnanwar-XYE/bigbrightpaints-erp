...
public final class CostingMethodUtils {
  ...
  public static <T> T selectWeightedAverageValue(
      String method, Supplier<T> weightedAverageSupplier, Supplier<T> nonWeightedSupplier) {
  ...
  public static FinishedGoodBatchSelectionMethod resolveFinishedGoodBatchSelectionMethod(
      String method) {
