...
public class EnterpriseAuditTrailController {
    ...
    public ResponseEntity<ApiResponse<MlAuditIngestResponse>> ingestMlEvents(
        ...
        MlAuditIngestResponse response = enterpriseAuditTrailService.ingestMlInteractions(
    ...
    public ResponseEntity<ApiResponse<PageResponse<BusinessAuditEventResponse>>> businessEvents(
        ...
        PageResponse<BusinessAuditEventResponse> result = enterpriseAuditTrailService.queryBusinessEvents(
    ...
    public ResponseEntity<ApiResponse<PageResponse<MlInteractionEventResponse>>> mlEvents(
            ...
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "50") int size) {
        PageResponse<MlInteractionEventResponse> result = enterpriseAuditTrailService.queryMlEvents(
