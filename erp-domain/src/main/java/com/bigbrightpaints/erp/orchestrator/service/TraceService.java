...
public class TraceService {
  ...
  public void record(
      String traceId, String eventType, String companyCode, Map<String, Object> details) {
  ...
  public List<AuditRecord> getTrace(String traceId) {
    ...
    return auditRepository.findByTraceIdAndCompanyIdOrderByTimestampAsc(
        sanitizedTraceId, company.getId());
  }
