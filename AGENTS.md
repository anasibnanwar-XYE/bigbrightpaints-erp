...
- Use orchestrator approval for narrow high-risk remediation packets that keep the current canonical behavior intact; escalate to human approval if the packet widens privileges, changes tenant boundaries, adds compatibility shims, or introduces destructive migration risk.
