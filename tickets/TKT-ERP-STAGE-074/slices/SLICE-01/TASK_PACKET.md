...
Lane: `w1`
Branch: `tickets/tkt-erp-stage-074/accounting-domain`
Worktree: `/home/realnigga/Desktop/orchestrator_erp_worktrees/_tmp_orch_exec_active_worktrees/TKT-ERP-STAGE-074/accounting-domain`

## Objective
Extend duplicate-target fail-closed policy to dealer receipt and supplier payment allocation endpoints with deterministic replay-safe diagnostics
