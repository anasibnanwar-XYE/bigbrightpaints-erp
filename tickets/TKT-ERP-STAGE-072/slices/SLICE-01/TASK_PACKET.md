...
Lane: `w1`
Branch: `tickets/tkt-erp-stage-072/accounting-domain`
Worktree: `/home/realnigga/Desktop/orchestrator_erp_worktrees/_tmp_orch_exec_active_worktrees/TKT-ERP-STAGE-072/accounting-domain`

## Objective
Fail closed when a single settlement request repeats the same invoice/purchase target to preserve deterministic allocation semantics
