...
Lane: `w1`
Branch: `tickets/tkt-erp-stage-049/auth-rbac-company`
Worktree: `/home/realnigga/Desktop/orchestrator_erp_worktrees/_tmp_orch_exec_worktrees/TKT-ERP-STAGE-049/auth-rbac-company`

## Objective
M18-S2A: enforce superadmin-only controller prefilters for tenant bootstrap, lifecycle-state, and tenant-metrics endpoints
...
- `cd erp-domain && mvn -B -ntp -Dtest='AuthTenantAuthorityIT,CompanyControllerIT' test`
