...
Lane: `w1`
Branch: `tickets/tkt-erp-stage-047/auth-rbac-company`
Worktree: `/home/realnigga/Desktop/orchestrator_erp_worktrees/_tmp_orch_exec_worktrees/TKT-ERP-STAGE-047/auth-rbac-company`

## Objective
Deliver M18-S2A baseline tenant metrics endpoint (active users + lifecycle) with superadmin-only enforcement
...
- `erp-domain/src/main/java/com/bigbrightpaints/erp/modules/auth/domain/UserAccountRepository.java`
