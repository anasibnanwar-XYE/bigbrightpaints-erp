...
Lane: `w2`
Branch: `tickets/tkt-erp-stage-050/refactor-techdebt-gc`
Worktree: `/home/realnigga/Desktop/orchestrator_erp_worktrees/_tmp_orch_exec_worktrees/TKT-ERP-STAGE-050/refactor-techdebt-gc`

## Objective
M18-S2A: extend tenant metrics payload with deterministic API activity and error-rate counters for superadmin control-plane observability
