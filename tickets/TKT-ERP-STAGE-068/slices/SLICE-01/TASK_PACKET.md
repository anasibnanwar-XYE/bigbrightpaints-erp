...
Lane: `w1`
Branch: `tickets/tkt-erp-stage-068/purchasing-invoice-p2p`
Worktree: `/home/realnigga/Desktop/orchestrator_erp_worktrees/_tmp_orch_exec_worktrees/TKT-ERP-STAGE-068/purchasing-invoice-p2p`

## Objective
Fix deterministic PurchaseReturnIdempotencyRegressionIT failure blocking strict-lane merges
...
Required output:
- identity line: `I am purchasing-invoice-p2p and I own SLICE-01.`
- files_changed
- commands_run
- harness_results
- residual_risks
