...
/**
 * Staging table for Tally dealer data (Sundry Debtors)
 */
@Entity
@Table(name = "stg_tally_dealers")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(callSuper = true)
public class StagingDealer extends BaseEntity {
    ...
    @Column(name = "generated_dealer_code", length = 64)
    private String generatedDealerCode;
