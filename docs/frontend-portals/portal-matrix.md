...
| `accounting` | `/accounting/*` | `/api/v1/accounting/**`, `GET /api/v1/reports/**`, accounting-owned `/api/v1/portal/support/tickets/**` | COA, journals, reconciliation, period close, finance reports, accounting support workflows | tenant onboarding, tenant Users & Access lifecycle controls, dispatch execution, dealer self-service |
