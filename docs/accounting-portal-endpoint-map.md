...
| Endpoint | Frontend should put | Backend expects | Returns |
|---|---|---|---|
| `POST /api/v1/accounting/catalog/import` | create-form; req: file (body); opt: Idempotency-Key (header); states: loading, error, success | path=-; query=-; body=optional; ct=multipart/form-data | ok 200; err - |
