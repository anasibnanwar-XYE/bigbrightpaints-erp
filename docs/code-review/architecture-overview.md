...
| --- | --- | --- |
| accounting | `/api/v1/accounting`, `/api/v1/accounting/configuration`, `/api/v1/accounting/payroll/payments` | `modules/accounting/controller/AccountingController.java`, `AccountingConfigurationController.java`, `JournalController.java` |
