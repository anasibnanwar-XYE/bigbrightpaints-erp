...
- The current contract normalizes tenant-boundary authorization and audit behavior across force-reset, status enable/disable, lock/unlock, session revoke, and MFA disable. Retired suspend, unsuspend, and hard-delete user aliases are absent/non-mutating.
