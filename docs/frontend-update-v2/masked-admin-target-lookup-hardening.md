...
- The admin role surface is now read-only. `GET /api/v1/admin/roles` remains the catalog endpoint, and role mutation is not part of the admin contract anymore.
