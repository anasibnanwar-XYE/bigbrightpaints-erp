...
4. **First controlled transaction in ERP** (one sale + one purchase)
5. **Formal go-live approval** from finance and operations owners
...
For technical CSV examples and the archived error dictionary, see **`docs/migration-guide.md`**.
