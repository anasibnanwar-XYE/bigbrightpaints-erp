...
- 2026-02-17: `TKT-ERP-STAGE-048` queued (planned, dispatch-ready) for M18-S2A authority-gap closure: enforce superadmin-only tenant configuration updates to prevent tenant-admin override of platform-level company controls.
