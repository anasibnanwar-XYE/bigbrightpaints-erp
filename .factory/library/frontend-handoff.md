...
- 2026-03-06 `auth-compatibility-regression-handoff`: admin user-control no-content endpoints are documented as `204 No Content` for canonical operations; retired admin suspend, unsuspend, hard-delete, and admin settings aliases are no longer published.
...
3. **User creation with role assignment**
   ...
   8. Lock/unlock, session-revocation, and MFA-disable endpoints remain available for direct account operations; retired suspend/unsuspend/hard-delete aliases are absent.
