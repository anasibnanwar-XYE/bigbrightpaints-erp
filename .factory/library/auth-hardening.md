...
- As of 2026-03-07 `masked-admin-lock-scope-regression-fix`, tenant-admin status, lock/unlock, session-revoke, and MFA-disable denials return the same masked `400 User not found` contract for foreign ids. Retired suspend, unsuspend, and hard-delete user aliases remain absent/non-mutating.
