...
ACCOUNTING_SERVICE="${AUDIT_TRAIL_ACCOUNTING_SERVICE:-$ROOT_DIR/erp-domain/src/main/java/com/bigbrightpaints/erp/modules/accounting/service/AccountingAuditService.java}"
